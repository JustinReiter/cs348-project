...
ii)   Login/Create Account to Persist Player Data Across Multiple Sessions
      Primarily implemented in index.php
      
iii)  Pokemon Search Page (Search by Type, Name, and Pokedex Number)
      Implemented in pokemon.php

iv)   Favourite/Unfavourite Pokemon feature for quick access
      Implemented in pokemon.php and favouritePokemon.php

v)    A page to generate/add specific Pokemon instances to your team with randomized stats
      Implemented in catchPokemon.php

vi)   The ability to populate and assign an order to your party (team) of Pokemon
      Implemented in organizePokemon.php

vii)  User information page with display of favourited Pokemon
      Implemented in profile.php

viii) Detailed individual Pokemon stats with images
